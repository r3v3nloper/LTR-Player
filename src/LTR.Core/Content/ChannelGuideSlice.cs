...
/// of queries for two rows apiece. It carries <see cref="GuideProgrammeSummary"/> rather than whole
/// entries for the related reason — the row displays two titles and two times, and nothing else.
/// </remarks>
...
public sealed record ChannelGuideSlice(
    int ChannelId,
    GuideProgrammeSummary? Now,
    GuideProgrammeSummary? Next);
