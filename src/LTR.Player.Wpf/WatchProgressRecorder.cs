...
public sealed class WatchProgressRecorder
{
    ...
    /// beginning — which is what an initial sample of zero would do.
    /// </param>
    ...
    /// <summary>
    /// Writes down what was followed, and stops following it.
    /// </summary>
    /// <remarks>
    ...
    public async Task RecordAsync(CancellationToken cancellationToken)
    {
        ...
        {
            PlayerLog.ProgressNotRecorded(_logger, exception, kind.ToString(), itemId);
        }
    }
}
